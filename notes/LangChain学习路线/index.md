---
url: /my_notes/notes/LangChain学习路线/index.md
---
...
| **3.2 文件系统与上下文管理** | 为什么 Agent 需要文件系统、内置文件工具（ls/read\_file/write\_file/edit\_file/glob/grep）、FilesystemBackend（root\_dir / virtual\_mode）、Filesystem 与 Store 两种后端选型 | [📖 查看](./第三阶段-Deep-Agents深入/3.2-文件系统与上下文管理.md) |
...
| **3.4 人类审批与安全实践** | `interrupt_on` 审批配置、interrupt 必须配 checkpointer、StoreBackend 必须配 store、thread\_id 保持对话、常见坑与安全最佳实践 | [📖 查看](./第三阶段-Deep-Agents深入/3.4-人类审批与安全实践.md) |
