---
url: /my_notes/notes/Linux学习路线/index.md
---
...
| **4.4 Docker 与容器化基础** | Docker 核心概念（镜像/容器/仓库）、Dockerfile 编写最佳实践、docker-compose 多容器编排、容器日志与监控、Docker 与虚拟机对比 | [📖 查看](./第四阶段-运维实战与脚本/4.4-Docker与容器化基础.md) |
