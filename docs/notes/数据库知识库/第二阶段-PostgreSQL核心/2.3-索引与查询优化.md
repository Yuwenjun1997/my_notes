---
title: 3-索引与查询优化
createTime: 2026/08/18 13:37:39
permalink: /notes/数据库知识库/di-er-jie-duan-postgre-sql-he-xin/3-suo-yin-yu-cha-xun-you-hua/
---
# 索引与查询优化
...
| `Memory Usage` | 操作符内存消耗 | work_mem 不足会触发磁盘临时文件 |
