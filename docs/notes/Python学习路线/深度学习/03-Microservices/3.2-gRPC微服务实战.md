...
permalink: /notes/Python学习路线/shen-du-xue-xi/03-microservices/2-g-rpc-wei-fu-wu-shi-zhan/
---
# gRPC 微服务实战
...
| 全链路追踪 | metadata 传递 trace_id，接入 OpenTelemetry |
...
2. 用 grpc_tools 生成 `user_pb2.py` 与 `user_pb2_grpc.py`
