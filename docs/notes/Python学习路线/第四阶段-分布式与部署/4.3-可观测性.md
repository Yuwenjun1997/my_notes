...
permalink: /notes/Python学习路线/di-si-jie-duan-fen-bu-shi-yu-bu-shu/3-ke-guan-ce-xing/
---
# 可观测性
...
1. **Trace（追踪）**：一次请求贯穿多个服务的完整链路，用 trace_id 标识
2. **Span（跨度）**：链路中的一个操作单元，用 span_id 标识，父子关系形成树
