...
permalink: >-
  /notes/JAVA学习路线/shen-du-xue-xi/04-yun-wei-yu-gong-cheng-hua/3-xing-neng-ce-shi-yu-tiao-you/
---
# 性能测试与调优
...
| Loop Count | 循环次数 | 压测持续时长 = ramp_time + (loop_count - 1) * 单次耗时 |
...
| 大量磁盘排序 | `SHOW STATUS LIKE 'Sort%'` | 优化排序字段、增加 sort_buffer |
| 缓冲池太小 | `SHOW STATUS LIKE 'Innodb_buffer_pool%'` | 增大 innodb_buffer_pool_size |
