---
title: 3-Docker-K8s进阶实战
createTime: 2026/08/15 17:33:05
permalink: >-
  /notes/JAVA学习路线/shen-du-xue-xi/04-yun-wei-yu-gong-cheng-hua/3-docker-k-8-s-jin-jie-shi-zhan/
---
...
**GC 日志配置（已内嵌在基础 Dockerfile 的 JAVA_OPTS 中）：**
