---
title: 3-JVM内存模型与GC调优
createTime: 2026/08/15 17:33:05
permalink: >-
  /notes/JAVA学习路线/shen-du-xue-xi/01-java-bing-fa-bian-cheng-yu-jvm/3-jvm-nei-cun-mo-xing-yu-gc-tiao-you/
---
# JVM 内存模型与 GC 调优
...
|--------|---------|--------|-------|--------|
| 无锁 | unused | identity_hashcode | 0 | 01 |
