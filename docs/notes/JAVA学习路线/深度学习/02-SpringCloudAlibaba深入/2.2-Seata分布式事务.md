...
permalink: >-
  /notes/JAVA学习路线/shen-du-xue-xi/02-spring-cloud-alibaba-shen-ru/2-seata-fen-bu-shi-shi-wu/
---
# Seata 分布式事务学习文档
...
| 二阶段回滚失败 | undo log 被删除或数据被修改 | 检查 undo_log 表是否正常，查看 Server 日志 |
