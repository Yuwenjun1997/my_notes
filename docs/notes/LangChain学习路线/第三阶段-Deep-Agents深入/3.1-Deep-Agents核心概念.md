---
title: 1-Deep-Agents核心概念
createTime: 2026/08/15 17:33:06
permalink: >-
  /notes/LangChain学习路线/di-san-jie-duan-deep-agents-shen-ru/1-deep-agents-he-xin-gai-nian/
---
# Deep Agents 核心概念
...
|:-----|:---------------------------|:---------------|
| 持久化 | 自己接 Checkpointer + thread_id | `checkpointer=` 参数 |
...
1. **创建 Deep Agent**（最小可用版），system_prompt 设为"你是一位软件工程师助理"。
