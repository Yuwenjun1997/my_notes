...
permalink: >-
  /notes/LangChain学习路线/di-san-jie-duan-deep-agents-shen-ru/2-wen-jian-xi-tong-yu-shang-xia-wen-guan-li/
---
# 文件系统与上下文管理
...
> ⚠️ `virtual_mode` 为 True 时，Agent 可以用相对路径跳出 root_dir，操作更自由但**更危险**。生产环境请设为 False，并配合人工审批（下一节）使用。
