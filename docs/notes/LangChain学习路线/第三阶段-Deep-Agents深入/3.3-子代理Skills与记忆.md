---
title: 3-子代理Skills与记忆
createTime: 2026/08/15 17:33:06
permalink: >-
  /notes/LangChain学习路线/di-san-jie-duan-deep-agents-shen-ru/3-zi-dai-li-skills-yu-ji-yi/
---
# 子代理、Skills 与记忆
...
| 对比维度 | Skills | system_prompt（系统提示词） |
|:---------|:-------|:---------------------------|
| 加载时机 | **按需**加载 | **每次启动**都加载 |
| 占上下文 | 用时才占 | 一直占着 |
...
| 生命周期 | 会话结束/换 thread_id 就换 | 长期存在，可被多个会话读 |
